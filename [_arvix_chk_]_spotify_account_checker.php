...
echo "   ####################  |___________________________________________|\n";
echo "_________________________|     Made by Borayach                      |\n";
echo "_____________________________________________________________________|\n";
echo "_____________________________________________________________________|\n";
echo "_____________________________________________________________________|\n";
echo "\n\n";
...
$ch10 = curl_init();
curl_setopt($ch10, CURLOPT_URL, "https://checker.arvix.my.id/get-url.php?chk_id=5");
